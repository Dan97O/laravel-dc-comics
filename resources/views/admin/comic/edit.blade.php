...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.comic.update') }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" class="form-control" placeholder="Comic name here "
                    aria-describedby="nameHelper" value="{{ $comics->title }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="thumb" id="thumb" class="form-control" placeholder="Comic image here "
                    aria-describedby="imageHelper" value="{{ $comics->thumb }}">
                <small id="imageHelper" class="text-muted">Type the image of the Comic max 50 characters</small>
            </div>
            <div class="mb-3">
                <label for="price" class="form-label">Price</label>
                <input type="number" step="0.01" name="price" id="price" class="form-control"
                    placeholder="Comic price here " aria-describedby="priceHelper" value="{{ $comics->price }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="series" id="series" class="form-control" placeholder="Comic price here "
                    aria-describedby="priceHelper" value="{{ $comics->series }}">
